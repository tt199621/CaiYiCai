...
import com.example.caiyicai.adapter.QuestionAdapter;
...
public class QuestionsActivity extends AppCompatActivity implements Robot.NlpListener, Robot.TtsListener {
    ...
    public void initData(){
        ...
        lists.add("会员有什么权益？");
        lists.add("你们展位是做什么的？");
        lists.add("材易采的核心价值是什么？");
        lists.add("材易采核心业务是什么？");
        lists.add("你们合作的品牌有哪些？");
        lists.add("材易采小程序能做什么？");
        lists.add("你们公司什么时候成立？");
        lists.add("你们以后的发展方向是什么？");
        lists.add("城市合伙人权益有哪些？");
        lists.add("今年陶博会有什么亮点可看？");
        lists.add("陶博会有什么活动？");
        lists.add("中国陶瓷城馆在哪里？");
        lists.add("陶瓷城馆有哪些参展商？");
        lists.add("陶瓷城里面有哪些固定品牌？");
        lists.add("中国陶瓷总部基地在哪里？");
        lists.add("总部基地有什么看？");
        lists.add("总部基地有哪些参展商？");
        lists.add("总部基地里面有哪些固定品牌？");
        lists.add("佛山会展中心在哪里？");
        lists.add("会展中心有什么看？");
        lists.add("会展中心有哪些参展商？");
        lists.add("附近有好吃的吗？");
        lists.add("我要订物流货运");
        lists.add("附近有什么酒店？");
        lists.add("展会附近哪里有汽车站？");
        lists.add("火车站在哪里？");
        lists.add("这里有前往广州的穿梭车吗？");
        lists.add("最近的候机楼位置在哪里？");
        lists.add("距离展会最近的地铁站在哪里？");
        lists.add("有自动柜员机吗？");

        QuestionAdapter adapter=new QuestionAdapter(lists,QuestionsActivity.this);
